...
## Project Structure
    ...
    ├── fairwinds_analytics_41759  # Django project configurations
...
1. Clone this repo and `cd fairwinds_analytics_41759`
...
2. Clone this repo and `cd fairwinds_analytics_41759`
