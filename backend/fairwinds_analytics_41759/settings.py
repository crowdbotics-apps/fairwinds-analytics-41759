"""
Django settings for fairwinds_analytics_41759 project.
...
ROOT_URLCONF = 'fairwinds_analytics_41759.urls'
...
WSGI_APPLICATION = 'fairwinds_analytics_41759.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fairwinds_analytics_41759 API",
    "DESCRIPTION": "API documentation for fairwinds_analytics_41759 App",
    "VERSION": "v1",
}
